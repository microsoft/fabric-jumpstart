...
- [`src/fabric_jumpstart/CONTRIBUTING.md`](../src/fabric_jumpstart/CONTRIBUTING.md) — Python library only (adding jumpstarts, dev setup)
- [`src/fabric_jumpstart_web/CONTRIBUTING.md`](../src/fabric_jumpstart_web/CONTRIBUTING.md) — Website & Python via WSL (dev setup, conventions)
