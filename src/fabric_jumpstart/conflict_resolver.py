...
class ConflictUI:
    ...
    def render_conflict_html(
        ...
        result = ''.join([
            ...
            '<h3 style="color: #323130; font-size: 18px; margin: 0 0 12px 0;">⚠️ Name conflicts detected</h3>',
            ...
            '<div class="install-conflict-snippets" style="margin-top: 16px;">',
            '<p style="margin: 0 0 12px 0; font-weight: 600;">Resolve by choosing one of the options:</p>',
            snippet1,
            snippet2,
            snippet3,
            '</div>',
