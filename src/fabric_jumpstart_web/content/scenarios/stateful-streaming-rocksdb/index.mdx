...
![How RocksDB on OneLake enables highly concurrent flushes across hundreds of Executor nodes despite update conflicts](images/stateful-stream-processing.png)
